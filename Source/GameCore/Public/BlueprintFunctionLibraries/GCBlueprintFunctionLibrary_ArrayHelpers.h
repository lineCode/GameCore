...
#include "GCBlueprintFunctionLibrary_ArrayHelpers.generated.h"
 ...
 */
UCLASS()
class GAMECORE_API UGCBlueprintFunctionLibrary_ArrayHelpers : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
