...
/**
 * Struct describing a scene cast
 */
USTRUCT()
struct HELPERLIBRARIES_API FSceneCastInfo
{
	GENERATED_BODY()
...
public:
	 ...
	 * @param  OutShooterHits            Hit results
	 * @param  OutSceneCastInfo          Struct that describes the scene cast
