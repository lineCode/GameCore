...
#include "HLBlueprintFunctionLibrary_CollisionQueries.generated.h"
 ...
 */
UCLASS()
class HELPERLIBRARIES_API UHLBlueprintFunctionLibrary_CollisionQueries : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
